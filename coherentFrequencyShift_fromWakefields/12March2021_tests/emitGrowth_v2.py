...
if __name__ == '__main__':
    ...
    dampingRate = zeff_dampingRate * cst.e**2 *N / (16.0 * np.pi * cst.m_p * gamma * Qx * frev * sigmaz)

    coherentDQ = zeff_coherentDQ * cst.e ** 2 * N / (16.0 * np.pi * cst.m_p * gamma * Qx * frev * sigmaz)
